...
char* segregate_string_mark_half(char* pass2, char* mark, char c){
    ...
    for (int j = 0; j<i; j++){
        ...
        msg1_add = add_first_char(msg1, c);
        msg2_add = add_first_char(msg2, c);
...
int main(){
    ...
    char *ms = segregate_string_mark_half(passage, "as", '|');
    printf("int main:---------------------------------%d results------------------------------------------------------------------\n", number_of_objects);
    printf("`%s`\n", ms);
    printf("-----------------------------------------------------------------------------------------------------------------\n");
}